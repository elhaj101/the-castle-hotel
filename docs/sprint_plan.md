...
This plan is mapped to the README requirements and Learning Outcomes (LO1-LO7).
Each task includes the pages, functions, and features to ensure nothing is left
untackled.
